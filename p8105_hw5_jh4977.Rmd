...
```
## Comment
The probability that at least two people share a birthday increases rapidly with group size — rising from near zero when n is small to about 50% around n = 23, illustrating the classic birthday paradox where coincidences occur much more often than intuition suggests.
