...
When \( \mu \) = 0, the rejection proportion is close to 0.05, matching the nominal Type I error rate. As μ increases from 1 to 6, the power increases monotonically, exceeding about 80% around \( \mu \) ≈ 3 and approaching 1 for larger effect sizes.
